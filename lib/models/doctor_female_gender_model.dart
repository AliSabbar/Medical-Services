...
//
//     final allFemaleDr = allFemaleDrFromJson(jsonString);

import 'dart:convert';

AllFemaleDr allFemaleDrFromJson(String str) => AllFemaleDr.fromJson(json.decode(str));

String allFemaleDrToJson(AllFemaleDr data) => json.encode(data.toJson());
...
class AllFemaleDr {
    ...
    factory AllFemaleDr.fromJson(Map<String, dynamic> json) => AllFemaleDr(
        code: json["code"],
