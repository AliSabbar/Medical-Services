...
//
//     final allDrByRating = allDrByRatingFromJson(jsonString);

import 'dart:convert';

AllDrByRating allDrByRatingFromJson(String str) => AllDrByRating.fromJson(json.decode(str));

String allDrByRatingToJson(AllDrByRating data) => json.encode(data.toJson());
...
class AllDrByRating {
    ...
    factory AllDrByRating.fromJson(Map<String, dynamic> json) => AllDrByRating(
        code: json["code"],
