...
//
//     final allDrByHighCost = allDrByHighCostFromJson(jsonString);

import 'dart:convert';

AllDrByHighCost allDrByHighCostFromJson(String str) =>
    AllDrByHighCost.fromJson(json.decode(str));

String allDrByHighCostToJson(AllDrByHighCost data) =>
    json.encode(data.toJson());

class AllDrByHighCost {
  AllDrByHighCost({
    required this.code,
    required this.data,
  ...
  factory AllDrByHighCost.fromJson(Map<String, dynamic> json) =>
      AllDrByHighCost(
        code: json["code"],
