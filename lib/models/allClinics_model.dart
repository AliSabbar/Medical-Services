...
//
//     final allClinicsModel = allClinicsModelFromJson(jsonString);

import 'dart:convert';

AllClinicsModel allClinicsModelFromJson(String str) => AllClinicsModel.fromJson(json.decode(str));

String allClinicsModelToJson(AllClinicsModel data) => json.encode(data.toJson());
...
class AllClinicsModel {
    ...
    factory AllClinicsModel.fromJson(Map<String, dynamic> json) => AllClinicsModel(
        code: json["code"],
